const base_url = "https://e-shop-project-gdkd.vercel.app/api/v1";
export const base_url_v2 = "https://e-shop-project-gdkd.vercel.app/api/v2";
...
export const getCategories = async () => {
  const response = await fetch(
    `https://e-shop-project-gdkd.vercel.app/api/v1/category?status=true`
  );
  const json = await response.json();
  return json;
};
...
export const getCategories2 = async () => {
  const response = await fetch(
    `https://e-shop-project-gdkd.vercel.app/api/v1/category`
  );
  const json = await response.json();
  return json;
};
...
export const getCategoriesAndSubCategory = async () => {
  const response = await fetch(
    `https://e-shop-project-gdkd.vercel.app/api/v1/category/category-and-subcategory`
  );
  const json = await response.json();
  return json;
};
