...
const BDAutoCity = ({ shippingCost, setShippingCost }) => {
  ...
  //     const url = `https://e-shop-project-two.vercel.app/api/v1/delivery-cost/get-delivery-for-user?city=${districtName}`;
  //     fetch(url)
  //         .then((res) => res.json())
  ...
  const { data, isLoading, error } = useQuery("myData", async () => {
    const response = await fetch(
      "https://e-shop-project-two.vercel.app/api/v1/delivery-cost"
    );
