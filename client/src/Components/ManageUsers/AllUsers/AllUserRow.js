  ...
  return (
    <tr key={user.id} className="whitespace-nowrap ">
      ...
      <td className="px-6 py-4 flex flex-col gap-1">
        <span className=" ">Padding Cashback : <span className=" text-[17px] font-bold">{user.padding_wallet}</span></span>
        <span className=" ">Active Cashback  :<span className=" text-[17px] font-bold">{user.wallet}</span></span>
      </td>
