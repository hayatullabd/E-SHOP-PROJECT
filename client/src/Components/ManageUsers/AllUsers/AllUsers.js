...
const AllUsers = () => {
  ...
  let baseUrl = server_url + "/user?sort=-createdAt"; 
  ...
  return (
    <div className=" pr-5 ">
      <div className="flex flex-col md:flex-row  md:justify-between sm:mb-5">
          ...
          <table className="w-full table-auto bg-[#F3F7FB]  divide-y divide-gray-300	">
            <thead className=" bg-primary text-white font-bold text-lg">
              <tr>
                ...
                <th className="px-6 py-4 text-start text-white">Cashback</th>
